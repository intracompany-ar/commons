...
@if(config('commons.setFonts'))
    ...
    <style media="screen">
        ...
        @font-face {
            ...
            font-style: normal;
            font-weight: 400;
            src: local('Geogtq-Md'), local('Geogtq-Md'), url('fonts/Geogtq-Md.otf') format('opentype');
            unicode-range: U+0000-00FF, U+0131, U+0152-0153, U+02BB-02BC, U+02C6, U+02DA, U+02DC, U+2000-206F, U+2074, U+20AC, U+2122, U+2191, U+2193, U+2212, U+2215, U+FEFF, U+FFFD;/*@*/
        }
    </style>
    {{-- JAVASCRIPT --}}
    <script defer src="fonts/fonts.js"></script>
@endif

<link rel="icon" type="image/x-icon" href="{{ asset(config('commons.logo.icon_32')) }}">
<link rel="apple-touch-icon" sizes="180x180" href="{{ asset('img/img_icons/icono_grupo_180.png') }}">
